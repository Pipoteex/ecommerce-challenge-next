            ...
            < div className="flex items-center justify-between mx-auto p-4" >
                ...
                <div className='relative mr-[5%]'>
                    ...
                    </div>
                    {
                        openShoppingCart
                        &&
                        <div className='absolute left-[-300px] shadow-2xl px-5 pb-5 bg-[white] w-[400px] flex flex-col max-h-[600px]'>
                            ...
                            <div className='flex justify-center items-end'>
                                <button className="text-white bg-blue-700 w-full hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center">Comprar</button>
                            </div>
                        </div>
                    }
                </div >
